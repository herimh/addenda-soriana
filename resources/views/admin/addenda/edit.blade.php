		...
		@endif
		  ...
		  <div class="box">
		    ...
		    <div class="box-footer">
			  ...
			  <button type="submit" class="btn btn-primary ladda-button" data-style="zoom-in" name="send"><span class="ladda-label"><i class="fa fa-save"></i> {{ trans('label.send') }}</span></button>
